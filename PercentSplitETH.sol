...
import "./a/IERC20Approve.sol";
import "./a/IERC20IncreaseAllowance.sol";
import "./a/IERC20.sol";
import "./a/Initializable.sol";
import "./a/AddressUpgradeable.sol";
import "./a/SafeMath.sol";
import "./a/Clones.sol";
import "./a/BytesLibrary.sol";
...
contract PercentSplitETH is Initializable {
  ...
  // A representation of shares using 16-bits for efficient storage.
  ...
  // A representation of shares using 256-bits to ease integration.
  struct Share {
    address payable recipient;
